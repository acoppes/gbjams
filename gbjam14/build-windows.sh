...
export BUILD_COMMAND="${GEMSERK_UNITY_EDITOR_PATH_6003} -projectPath ${PROJECT_PATH} -buildTarget win64 -quit -silent-crashes -batchmode -nographics -logFile ${GEMSERK_GAME_BUILD_LOG_PATH} -executeMethod Gemserk.BuildTools.Editor.BuildScript.BuildWindows"
